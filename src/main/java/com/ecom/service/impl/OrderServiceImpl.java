...
public class OrderServiceImpl implements OrderService {
	...
	public void saveOrder(Integer userid, OrderRequest orderRequest) throws Exception {
		try {
			...
			for (Cart cart : carts) {
				if (cart.getProduct() == null || cart.getQuantity() <= 0) {
					throw new Exception("Invalid cart item found. Please refresh your cart.");
				}
			...
			// Delete all cart items for the user after order is placed
